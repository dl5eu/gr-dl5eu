...
#ifndef INCLUDED_DL5EU_DVBT_VITERBI_DECODER_H
#define INCLUDED_DL5EU_DVBT_VITERBI_DECODER_H
 ...
 * MSB - first, LSB last.
 */
class DL5EU_API dvbt_viterbi_decoder : virtual public gr::block
{
public:
...
#endif /* INCLUDED_DL5EU_DVBT_VITERBI_DECODER_H */
